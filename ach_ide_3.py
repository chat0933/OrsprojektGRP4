...
# cursor.execute("INSERT INTO achievements VALUES (NULL, ?, ?, ?)", (achievement1.name, achievement1.description, achievement1.completed))
# cursor.execute("INSERT INTO achievements VALUES (NULL, ?, ?, ?)", (achievement2.name, achievement2.description, achievement2.completed))
# cursor.execute("INSERT INTO achievements VALUES (NULL, ?, ?, ?)", (achievement3.name, achievement3.description, achievement3.completed))
# cursor.execute("INSERT INTO achievements VALUES (NULL, ?, ?, ?)", (achievement4.name, achievement4.description, achievement4.completed))
...
#def test():
    # DENE FUNKTION SKAL LAVE DATABSASENS TABEL
#    print("HEJ")
...
# DET VIRKER NU!!!!
def achiveinsert(bug_fixes):
    #bug_fixes = 0
    #ui.ach_ide_3_v2
    if bug_fixes >= 10:  #or bug_fixes == 10:
        task1.complete_achievement("Bug Spray")
        #cursor.execute("UPDATE achievements SET uid = 1")
