...
def createUserTable():
    ...
    Tablename = input("Testing if it will let me create a new tablename: ")
    cur.execute(f"CREATE TABLE IF NOT EXISTS [{Tablename}] (uid INTEGER PRIMARY KEY, name TEXT, description TEXT, completed INTEGER)")
